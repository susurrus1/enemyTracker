...
while True:
    ...
    frameMask = subtractor.apply(frame)
    ...
    grayFrame = cv2.bitwise_and(grayFrame, grayFrame, mask=frameMask)
    ...
    corners = cv2.goodFeaturesToTrack(grayFrame, maxCorners, 0.01, 10)
